...
parser = argparse.ArgumentParser(description='UDATCAR demo')
parser.add_argument('--config', type=str, default='../experiments/udatcar_r50_l234/config.yaml', help='config file')
parser.add_argument('--snapshot', type=str, default='../experiments/udatcar_r50_l234/udatcar_model.pth', help='model name')
