...
parser.add_argument('--dataset', type=str, default='NAT', # NAT NAT_L UAVDark70
        help='datasets')#OTB50 LaSOT UAV123 GOT-10k
parser.add_argument('--vis', action='store_true',default=False,
        help='whether visualzie result')
parser.add_argument('--snapshot', type=str, default=os.getcwd() + '/experiments/udatcar_r50_l234/udatcar_model.pth',
        help='snapshot of models to eval')

parser.add_argument('--config', type=str, default=os.getcwd() + '/experiments/udatcar_r50_l234/config.yaml',
        help='config file')
