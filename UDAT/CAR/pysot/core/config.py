...
__C.DATASET.SOURCE = ['VID', 'GOT'] # only train on COCO for test  'VID', , 'DET', 'YOUTUBEBB' , 'COCO', 'YOUTUBEBB'
__C.DATASET.TARGET = ['DarkTrack']  # only train on COCO for test  'VID', , 'DET', 'YOUTUBEBB'

__C.DATASET.VID = CN()
__C.DATASET.VID.ROOT = '/home/mist/v4r/train_dataset/vid/crop511'          # VID dataset path
__C.DATASET.VID.ANNO = '/home/mist/v4r/train_dataset/vid/train.json'
...
__C.DATASET.GOT = CN()
__C.DATASET.GOT.ROOT = '/home/mist/v4r/train_dataset/got10k/crop511'         # GOT dataset path
__C.DATASET.GOT.ANNO = '/home/mist/v4r/train_dataset/got10k/train.json'
