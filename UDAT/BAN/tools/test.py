...
parser.add_argument('--config', default=os.getcwd() + '/experiments/udatban_r50_l234/config.yaml', type=str,
        help='config file')
parser.add_argument('--snapshot', default=os.getcwd() + '/experiments/udatban_r50_l234/udatban_model.pth', type=str, 
...
def main():
    ...
    model_name = 'UDATBAN_' + str(args.snapshot.split('/')[-1][:-4]) + '_'+ str(hp['lr']) + '_' + str(hp['penalty_k']) + '_' + str(hp['window_lr'])
    ...
    if args.dataset in ['VOT2016', 'VOT2018', 'VOT2019']:
        ...
        # OPE tracking
        for v_idx, video in enumerate(dataset):
            if isfile(os.path.join(model_path, '{}.txt'.format(video.name))):
                print(video.name)
                continue
            if args.video != '':
                # test one special video
