...
from toolkit.datasets import NATDataset, NAT_LDataset, UAVDataset, UAVDark70Dataset
from toolkit.evaluation import OPEBenchmark, AccuracyRobustnessBenchmark, \
        EAOBenchmark, F1Benchmark

parser = argparse.ArgumentParser(description='tracking evaluation')
parser.add_argument('--tracker_path', '-p', type=str,default='./results/', # ./results hp_search_results/checkpoint_e13/
                    help='tracker result path')
parser.add_argument('--dataset', '-d', type=str,default='NAT', # NAT, NAT_L, UAVDark70
                    help='dataset name')
