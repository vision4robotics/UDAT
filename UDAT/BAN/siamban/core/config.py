...
# __C.DATASET.NAMES = ('VID', 'YOUTUBEBB', 'COCO', 'GOT10K', 'DarkTrack') # 'DET',  'LASOT'
__C.DATASET.SOURCE = ['VID', 'GOT10K'] # source domain
__C.DATASET.TARGET = ['DarkTrack'] # target domain

__C.DATASET.VID = CN()
__C.DATASET.VID.ROOT = '/YOUR/PATH/TO/vid/crop511'
__C.DATASET.VID.ANNO = '/YOUR/PATH/TO/vid/train.json'
...
__C.DATASET.GOT10K.ROOT = '/YOUR/PATH/TO/got10k/crop511'
__C.DATASET.GOT10K.ANNO = '/YOUR/PATH/TO/got10k/train.json'
...
__C.DATASET.DarkTrack.ROOT = '/YOUR/PATH/TO/NAT2021/crop511' 
__C.DATASET.DarkTrack.ANNO = '/YOUR/PATH/TO/NAT2021/train.json' 
__C.DATASET.DarkTrack.FRAME_RANGE = 50
__C.DATASET.DarkTrack.NUM_USE = 10000
